...
const InfoCard: React.FC<InfoCardProps> = ({ onBack }) => {
  return (
    <div className="flex flex-col flex-grow bg-slate-100 overflow-hidden">
      <header className="bg-white p-4 flex justify-between items-center border-b z-10 flex-shrink-0">
      ...
      <div className="flex-grow overflow-y-auto p-4 sm:p-6 lg:p-8">
        <section className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg prose max-w-none p-6 sm:p-8">
