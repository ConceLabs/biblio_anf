...
import { LEY_21459_DELITOS_INFORMATICOS_CONTENT } from './data/ley21459DelitosInformaticos';
import { LEY_21732_TERRORISMO_CONTENT } from './data/ley21732Terrorismo';
import { LEY_21057_ENTREVISTA_VIDEOGRADADA_CONTENT } from './data/ley21057EntrevistaVideograbada';
import { LEY_21675_VIOLENCIA_GENERO_CONTENT } from './data/ley21675ViolenciaGenero';
import { LEY_21595_DELITOS_ECONOMICOS_CONTENT } from './data/ley21595DelitosEconomicos';
...
import { LEY_MIGRACION_EXTRANJERIA_CONTENT } from './data/leyMigracionExtranjeria';
...
export const ICONS: { [key: string]: React.ReactNode } = {
  ...
  bomb: <i className="fa-solid fa-bomb fa-2x"></i>,
  camera: <i className="fa-solid fa-camera fa-2x"></i>,
  venus: <i className="fa-solid fa-venus fa-2x"></i>,
  passport: <i className="fa-solid fa-passport fa-2x"></i>,
};
...
export const MOCK_DOCUMENTS: Document[] = [
  ...
  { id: '29', category: Category.CodesAndLaws, title: 'LEY DE VIOLENCIA DE GENERO', iconKey: 'venus', type: DocType.MD, content: LEY_21675_VIOLENCIA_GENERO_CONTENT },
  ...
  { id: '26', category: Category.CodesAndLaws, title: 'LEY DE DELITOS INFORMÁTICOS', iconKey: 'screen', type: DocType.MD, content: LEY_21459_DELITOS_INFORMATICOS_CONTENT },
  { id: '27', category: Category.CodesAndLaws, title: 'LEY ANTITERRORISTA', iconKey: 'bomb', type: DocType.MD, content: LEY_21732_TERRORISMO_CONTENT },
  { id: '28', category: Category.CodesAndLaws, title: 'LEY DE ENTREVISTA VIDEOGRABADA', iconKey: 'camera', type: DocType.MD, content: LEY_21057_ENTREVISTA_VIDEOGRADADA_CONTENT },
  { id: 'ley-delitos-economicos', category: Category.CodesAndLaws, title: 'LEY DE DELITOS ECONÓMICOS', iconKey: 'moneyBillWave', type: DocType.MD, content: LEY_21595_DELITOS_ECONOMICOS_CONTENT },
  { id: 'ley-migracion-extranjeria', category: Category.CodesAndLaws, title: 'LEY DE MIGRACIÓN Y EXTRANJERÍA', iconKey: 'passport', type: DocType.MD, content: LEY_MIGRACION_EXTRANJERIA_CONTENT },
